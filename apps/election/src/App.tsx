...
export const App = () => {
  ...
  const toggleImmersive = () => {
    ...
    setImmersive(next);
    setNotice(next ? '已进入沉浸模式：LecPunch 提醒已静音并全屏显示。QQ、微信请在 Windows 专注助手中静音。' : '已退出沉浸模式。');
  };
